...
map("n", "<leader>sb", function() Snacks.picker.lines() end, { desc = "Buffer Lines" }) -- Duplicate in original config
...
map("n", "<leader>n", function() Snacks.notifier.show_history() end, { desc = "Notification History" }) -- Duplicate key in original config
